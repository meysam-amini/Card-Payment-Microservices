...
public abstract class AbstractTransfeProviderService<T> {
     ...
     * @param dto      the extra data object for each implementation.
     * @return Mono of type boolean
     */
    public abstract Mono<Boolean> callExchangeSP(String URI, Transfer transfer, T dto);
