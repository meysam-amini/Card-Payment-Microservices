...
public class FirstTransferProviderServiceImpl extends AbstractTransfeProviderService<FirstProviderDto> {
    ...
    private final String SP_1_ADDRESS = "http://localhost:8082/sp1/exchange";
    ...
    public Mono<ResponseEntity<String>> transfer(Transfer transfer) {
...

        {
            if (first_card_balance_ok) {
                ...
                Mono<Boolean> response = callExchangeSP(SP_1_ADDRESS, transfer, null);
    ...
    @Override
    public Mono<Boolean> callExchangeSP(String URI, Transfer transfer, FirstProviderDto dto) {
